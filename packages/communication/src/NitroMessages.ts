...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.USER_PERMISSIONS_MAP, UserPermissionsMapEvent);
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.CATALOG_ADMIN_CREATE_OFFER, CatalogAdminCreateOfferComposer);
        this._composers.set(OutgoingHeader.CATALOG_ADMIN_DELETE_OFFER, CatalogAdminDeleteOfferComposer);
        ...
        this._composers.set(OutgoingHeader.FURNITURE_FLOOR_POSITION_UPDATE, UpdateFurniturePositionComposer);
